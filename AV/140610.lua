...
function draw()	
	...
	for a in pairs(agents) do
		draw2D.push()
			...
			draw2D.color(a.color.r, a.color.g, a.color.b,0.2)
			--draw2D.rect(0, 0, 2, 0.1)
			draw2D.color(0.2, 0, 0.9,0.6)
			draw2D.circle(1, 0.2, 0.2)
